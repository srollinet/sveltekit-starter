...
<!-- For checkpoint task examples and patterns, see @/workspaces/sveltekit-starter/.claude/get-shit-done/references/checkpoints.md -->
...
See `/workspaces/sveltekit-starter/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/workspaces/sveltekit-starter/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/workspaces/sveltekit-starter/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
