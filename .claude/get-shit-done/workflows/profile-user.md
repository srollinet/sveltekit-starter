...
Key references:
- @/workspaces/sveltekit-starter/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/workspaces/sveltekit-starter/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/workspaces/sveltekit-starter/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/workspaces/sveltekit-starter/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/workspaces/sveltekit-starter/.claude/get-shit-done/USER-PROFILE.md" "/workspaces/sveltekit-starter/.claude/get-shit-done/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /workspaces/sveltekit-starter/.claude/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
SCAN_RESULT=$(node /workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node /workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `/workspaces/sveltekit-starter/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/workspaces/sveltekit-starter/.claude/get-shit-done/references/user-profiling.md
...
**Get questions:**
```bash
QUESTIONS=$(node /workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANALYSIS_RESULT=$(node /workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
node /workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Profile written to /workspaces/sveltekit-starter/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /workspaces/sveltekit-starter/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /workspaces/sveltekit-starter/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
```bash
node /workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs generate-dev-preferences --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Generated /gsd-dev-preferences at /workspaces/sveltekit-starter/.claude/commands/gsd/dev-preferences.md"

**For CLAUDE.md profile section (if selected):**

```bash
node /workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node /workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to /workspaces/sveltekit-starter/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/workspaces/sveltekit-starter/.claude/get-shit-done/USER-PROFILE.backup.md"
```
...
Your profile:    /workspaces/sveltekit-starter/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /workspaces/sveltekit-starter/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /workspaces/sveltekit-starter/.claude/CLAUDE.md
```
