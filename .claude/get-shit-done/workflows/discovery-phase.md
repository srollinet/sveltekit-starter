...
See /workspaces/sveltekit-starter/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /workspaces/sveltekit-starter/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /workspaces/sveltekit-starter/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /workspaces/sveltekit-starter/.claude/get-shit-done/templates/discovery.md
...
Use /workspaces/sveltekit-starter/.claude/get-shit-done/templates/discovery.md.
