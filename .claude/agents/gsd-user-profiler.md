...
<reference>
@/workspaces/sveltekit-starter/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/workspaces/sveltekit-starter/.claude/get-shit-done/references/user-profiling.md` to load:
