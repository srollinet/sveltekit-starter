...
Reference full template: `/workspaces/sveltekit-starter/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/workspaces/sveltekit-starter/.claude/get-shit-done/templates/state.md`.
