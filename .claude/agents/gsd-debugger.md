...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /workspaces/sveltekit-starter/.claude
                  → checks /workspaces/sveltekit-starter/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /workspaces/sveltekit-starter/.claude/get-shit-done
                  → writes to /workspaces/sveltekit-starter/.claude/get-shit-done/hooks/
...
@/workspaces/sveltekit-starter/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/workspaces/sveltekit-starter/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
