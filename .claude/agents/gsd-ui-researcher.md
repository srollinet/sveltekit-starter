...
Use template from `/workspaces/sveltekit-starter/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/workspaces/sveltekit-starter/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
