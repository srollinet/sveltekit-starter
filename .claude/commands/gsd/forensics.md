...
<execution_context>
@/workspaces/sveltekit-starter/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/workspaces/sveltekit-starter/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
