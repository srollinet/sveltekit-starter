...
<execution_context>
@/workspaces/sveltekit-starter/.claude/get-shit-done/workflows/review.md
</execution_context>
...
<process>
Execute the review workflow from @/workspaces/sveltekit-starter/.claude/get-shit-done/workflows/review.md end-to-end.
</process>
