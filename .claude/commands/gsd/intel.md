...
Intel system is disabled. To activate:
  ...
  node /workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /workspaces/sveltekit-starter/.claude/get-shit-done/bin/gsd-tools.cjs
