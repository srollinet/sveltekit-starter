...
<execution_context>
@/workspaces/sveltekit-starter/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/workspaces/sveltekit-starter/.claude/get-shit-done/workflows/docs-update.md end-to-end.
