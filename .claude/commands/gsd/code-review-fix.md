...
<execution_context>
@/workspaces/sveltekit-starter/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @/workspaces/sveltekit-starter/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.
